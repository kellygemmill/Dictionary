...
const Footer = () => {
    return (
        <div style={style}>
            ...
            <Button style={buttonStyle} variant="outline-dark" href="https://github.com/kellygemmill/Dictionary-Frontend"
                target="_blank" rel="noopener noreferrer">Frontend (React)</Button> {'  '}
            <Button style={buttonStyle} variant="outline-dark" href="https://github.com/kellygemmill/Dictionary-Backend"
